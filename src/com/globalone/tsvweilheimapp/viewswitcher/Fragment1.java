...
import com.globalone.tsvweilheimapp.xmladapter.SitesAdapter;
import com.globalone.tsvweilheimapp.xmladapter.SitesXmlPullParser;
...
import com.globalone.tsvweilheimapp.xmladapter.StackSite;
...
public class Fragment1 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		tableLayoutLetzteWoche = (TableLayout) rootView
	...
	// TODO Ausfuehrung wurde in isMenuShown verteilt.. da dies erst dann
	// geladen wird wenn auch angezeigt
	...
	public class SitesDownloadTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			try {
				 ...
				 * 
				 * mAdapterLetzteWoche = new
				 * SitesAdapter(getApplicationContext(), -1,
				 * SitesXmlPullParser.getStackSitesFromFile(MainXML.this, 1));
				 */

				LinearLayout lay1 = (LinearLayout) getActivity().findViewById(
						R.id.linearLayoutTab1);
				LinearLayout lay2 = (LinearLayout) getActivity().findViewById(
