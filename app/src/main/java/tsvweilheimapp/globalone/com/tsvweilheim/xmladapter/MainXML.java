...
public class MainXML extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tableLayout = findViewById(R.id.tableLayoutTabelle);
		tableLayoutLetzteWoche = findViewById(R.id.tableLayoutLetzteWoche);
	...
	public class SitesDownloadTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			LinearLayout lay1 = findViewById(R.id.linearLayoutTab1);
			LinearLayout lay2 = findViewById(R.id.linearLayoutTab2);
	...
	void addFirstRow(int laufvar) {
		...
		if (laufvar == 0) {
			...
			TextView textview2 = findViewById(R.id.txtErgebnisOverTable);
		...
		//	textview2.setBackgroundResource(R.color.LightGrey);
			...
			TextView textview3 = findViewById(R.id.txtTabelleOverTable);
