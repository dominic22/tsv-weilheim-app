package tsvweilheimapp.globalone.com.tsvweilheim.listview;
...
public class MyListAdapter extends SimpleAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
		...
		LinearLayout lin = view.findViewById(R.id.layoutLeftColor);
		LinearLayout box = view.findViewById(R.id.box);
		TextView txtHeadline = view.findViewById(R.id.title);
		TextView txtShort = view.findViewById(R.id.message);
